...
Function should check is it possible to replace letters in t to get s, without changing the order of letters and same
letters should be replaced with same other letters.
