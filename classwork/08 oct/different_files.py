# You need to log the results of function sum(a, b) and function power(a, b) - to a file. + Log each time when this
# function calls - another file, with a timestamp. Make a decorator for this one. Advanced: add parameters for
# a decorator, which will allow you to specify the names of a file.
